...
//        0xccu8 => Instruction { op: Op::CPY, address_mode: AddressMode::Absolute, cycles: 4 },
            0xc6u8 => self.dec(AddressMode::ZeroPage),//Instruction { op: Op::DEC, address_mode: AddressMode::ZeroPage, cycles: 5 },
            0xd6u8 => self.dec(AddressMode::ZeroPageX),//Instruction { op: Op::DEC, address_mode: AddressMode::ZeroPageX, cycles: 6 },
            0xceu8 => self.dec(AddressMode::Absolute),//Instruction { op: Op::DEC, address_mode: AddressMode::Absolute, cycles: 6 },
            0xdeu8 => self.dec(AddressMode::AbsoluteX),//Instruction { op: Op::DEC, address_mode: AddressMode::AbsoluteX, cycles: 7 },
            0xcau8 => self.dex(),//Instruction { op: Op::DEX, address_mode: AddressMode::Implicit, cycles: 2 },
            0x88u8 => self.dey(),//Instruction { op: Op::DEY, address_mode: AddressMode::Implicit, cycles: 2 },
...
//        0x5eu8 => Instruction { op: Op::LSR, address_mode: AddressMode::AbsoluteX, cycles: 7 },
            0xeau8 => self.nop(),//Instruction { op: Op::NOP, address_mode: AddressMode::Implicit, cycles: 2 },
