...
impl<C : Cartridge> Core<C> {
    ...
    pub(crate) fn execute(&mut self, instruction: u8) {
        match instruction {
            ...
            0x0au8 => self.asl_acc(),
            0x06u8 => self.asl(AddressMode::ZeroPage),
            0x16u8 => self.asl(AddressMode::ZeroPageX),
            0x0eu8 => self.asl(AddressMode::Absolute),
            0x1eu8 => self.asl(AddressMode::AbsoluteX),
            0x90u8 => self.bcc(),
            0xb0u8 => self.bcs(),
            0xf0u8 => self.beq(),
...
//        0x20u8 => Instruction { op: Op::JSR, address_mode: AddressMode::Absolute, cycles: 6 },
            ...
            0x46u8 => self.lsr(AddressMode::ZeroPage), //Instruction { op: Op::LSR, address_mode: AddressMode::ZeroPage, cycles: 5 },
            0x56u8 => self.lsr(AddressMode::ZeroPageX),
            0x4eu8 => self.lsr(AddressMode::Absolute),
            0x5eu8 => self.lsr(AddressMode::AbsoluteX),
            0xeau8 => self.nop(),
...
//        0x2au8 => Instruction { op: Op::ROL, address_mode: AddressMode::Accumulator, cycles: 2 },
            0x26u8 => self.rol(AddressMode::ZeroPage),
            0x36u8 => self.rol(AddressMode::ZeroPageX),
            0x2eu8 => self.rol(AddressMode::Absolute),
            0x3eu8 => self.rol(AddressMode::AbsoluteX),
//        0x6au8 => Instruction { op: Op::ROR, address_mode: AddressMode::Accumulator, cycles: 2 },
            0x66u8 => self.ror(AddressMode::ZeroPage),
            0x76u8 => self.ror(AddressMode::ZeroPageX),
            0x6eu8 => self.ror(AddressMode::Absolute),
            0x7eu8 => self.ror(AddressMode::AbsoluteX),
